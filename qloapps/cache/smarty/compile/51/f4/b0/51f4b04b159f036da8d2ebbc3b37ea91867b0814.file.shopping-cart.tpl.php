...
<?php /*%%SmartyHeaderCode:17177392026647b8574eef79-75214911%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '17177392026647b8574eef79-75214911',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6647b8575469f8_31379670',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6647b8575469f8_31379670')) {function content_6647b8575469f8_31379670($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/html/tools/smarty/plugins/modifier.date_format.php';
...
">
	...
	<?php }?>
	<?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['total_discounts']->value!=0) {?><?php echo "1";?><?php } else { ?><?php echo "0";?><?php }?><?php $_tmp40=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['total_discounts_num'] = new Smarty_variable($_tmp40, null, 0);?>
	<?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['use_taxes']->value&&$_smarty_tpl->tpl_vars['show_taxes']->value) {?><?php echo "2";?><?php } else { ?><?php echo "0";?><?php }?><?php $_tmp41=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['use_show_taxes'] = new Smarty_variable($_tmp41, null, 0);?>
	<?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['total_wrapping']->value!=0) {?><?php echo "1";?><?php } else { ?><?php echo "0";?><?php }?><?php $_tmp42=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['total_wrapping_taxes_num'] = new Smarty_variable($_tmp42, null, 0);?>
...
<?php $_tmp43=ob_get_clean();?><?php if ($_tmp43<=9) {?>0<?php echo $_smarty_tpl->tpl_vars['rm_v']->value['num_rm'];?>
...
<?php $_tmp44=ob_get_clean();?><?php if ($_tmp44<=9) {?>0<?php echo $_smarty_tpl->tpl_vars['data_v']->value['adult'];?>
...
<?php $_tmp45=ob_get_clean();?><?php if ($_tmp45<=9) {?>0<?php echo $_smarty_tpl->tpl_vars['data_v']->value['children'];?>
